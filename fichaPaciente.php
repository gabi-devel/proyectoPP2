...
$comentarios = "SELECT comentario FROM coment WHERE id = '$variable'";
if (($result3 = mysqli_query($conexion, $comentarios)) === false) {
    die(mysqli_error($conexion));
};

$result4 =  mysqli_query($conexion, $comentarios);
$row = mysqli_fetch_assoc($result4);

if ($result4 = $conexion -> query($comentarios)) {
