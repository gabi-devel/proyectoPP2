                        ...
                        <div class="nav">
                            ...
                            <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" id="myForm" class="mx-3">
                                ...
                                <div class="d-grid gap-3 d-md-block mt-3">
                                    <button class="col-5" type="submit" name="buscar" id="buscar" value="Buscar">Buscar</button>
            ...
            echo 
                '<table border="0" cellspacing="2" cellpadding="2" class="table table-light"> 
                    ...
                    <tr>
                        ...
                        <td>'.$dato["sexo"].'</td> 
                        <td><form action="http://localhost/proyectoMio/dashboard2.php" method="post">
...
<nav id="add__container">
    <div class="add__div">
        <div class="add__item">
            ...
            <div id="add">
                <form role="form" action="dashboard2.php" id="agregarPaciente_Form">
                    <div class="mb-3">
...
<!-- date picker -->
<script type="proyectoPP2/text/javascript" src="node_modules\jquery\dist\jquery.min.js"></script> 
<script type="proyectoPP2/text/javascript" src="bootstrap\datepicker\bootstrap-datepicker.min.js"></script>
<link rel="stylesheet" href="proyectoPP2/bootstrap\datepicker\bootstrap-datepicker3.css"/>
<script>
